...
from utils.anglecalculations import angleKeepInterval, directionKeepInterval
from utils.coordconversion import polarToCart
from utils.constants import DENSITY_AIR, DENSITY_WATER
...
def Air():
    ...
    return -CONSTANT_AIR*(flowSpeed-BoatSpeed)**2*